...
import imageStyle from './sectioncomponents/imgcontainer.module.css'
    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <map name="puzzle-map">
            ...
            <area onClick={()=> display(<SECTION4_4/>)} alt="tal" title="tal"  coords="154,272,153,331,141,328,132,321,115,336,115,356,146,350,157,361,157,389,190,387,205,376,198,351,221,347,228,360,223,385,273,387,275,360,286,353,308,353,317,334,301,326,274,326,274,276,227,273,222,292,230,305,209,315,197,294,199,274" shape="poly"></area>
            <area onClick={()=> display(<SECTION4_3/>)} alt="sos" title="sos"  coords="274,273,273,232,240,240,229,223,239,207,271,208,277,155,318,159,317,186,329,196,343,191,341,159,392,158,395,203,413,207,410,232,401,231,392,270,351,270,344,250,351,238,336,229,316,233,316,251,318,268" shape="poly"></area>
        </map> <br/>
